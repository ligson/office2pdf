package org.ligson.office2pdf.test;
...
public class CreatePdf {
	 ...
	 * @throws IOException
	 */
	public Image getImageFile(String imagePath) throws BadElementException,
	...
	public String getPdfContext(String inputFilePath, String outputFilePath) {
		// 读取DOC文件内容
		// String htmlText = new
		// FileExtracter().extractDoc(inputFilePath,outputFilePath);
		// 把读取的HTML文件,生成一个字符串
	 ...
	 * @throws IOException
	 */
	public String createPDF(String imagePath0, String inputFilePath,
			String outputFilePath, String imagePath1, String outputPdf)
		...
		PdfWriter writer = PdfWriter.getInstance(document,
				new FileOutputStream(outPdfPath));
	 ...
	 * @throws IOException
	 */
	public String createPDF(String imagePath, String inputFilePath,
			String outputFilePath, String outputPdf) throws DocumentException,
			IOException {
	...
	public static void main(String[] args) {
		...
		try {
			String s = new CreatePdf().createPDF("c:/a.gif", "c:/s.doc",
					"c:/x.html", "a.pdf");
